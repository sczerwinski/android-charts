...
/**
 * Pie chart data set adapter for a list of `Int`s.
 *
 * @constructor Creates a pie chart data set adapter for a list of `Int`s.
 * @param context The context.
 * @param initialData Initial data set.
 */
class IntListPieChartAdapter @JvmOverloads constructor(
    context: Context,
    initialData: List<Int> = emptyList()
