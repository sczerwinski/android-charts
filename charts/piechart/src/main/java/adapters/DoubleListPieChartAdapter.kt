...
/**
 * Pie chart data set adapter for a list of `Double`s.
 *
 * @constructor Creates a pie chart data set adapter for a list of `Double`s.
 * @param context The context.
 * @param initialData Initial data set.
 */
class DoubleListPieChartAdapter @JvmOverloads constructor(
    context: Context,
    initialData: List<Double> = emptyList()
     ...
     * Data points.
     */
    var data: List<Double> = initialData
        set(value) {
            field = value
     ...
     */
    override val sum: Float get() = data.sum().toFloat()
     ...
     */
    override fun get(index: Int): Float = data[index].toFloat()
