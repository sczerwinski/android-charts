...
/**
 * Pie chart data set adapter for a list of `Long`s.
 *
 * @constructor Creates a pie chart data set adapter for a list of `Long`s.
 * @param context The context.
 * @param initialData Initial data set.
 */
class LongListPieChartAdapter @JvmOverloads constructor(
    context: Context,
    initialData: List<Long> = emptyList()
     ...
     * Data points.
     */
    var data: List<Long> = initialData
        set(value) {
            field = value
